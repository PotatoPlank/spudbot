...
class SetTenuredRole extends AbstractSubCommandSubscriber
{
    #[Inject]
    ...
    {
        if (!$interaction) {
            throw new BadMethodCallException('Setting a Tenured Role requires an interaction.');
        }
        ...
        $this->spud->interact()
            ->setTitle('Set Tenured Role')
            ->setDescription(
                "Set the tenured role."
